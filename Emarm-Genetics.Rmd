...
<span style = "color:violet">Study Area:</span> *Etheostoma marmorpinnum*'s range is restricted to a 20 rkm stretch of the lower Little River in eastern Tennessee. This stretch is bracketed by Fort Loudoun Dam downstream on the Tennessee River and Perry's Mill Dam upstream on the Little River. Three sites were selected, being the only known thriving populations (TN-33 Bridge Crossing, River John's, and Coulter's Bridge).

<span style = "color:violet">Methods:</span> Tissue samples were taken from the upper lobe of the caudal fin of 56 individuals. DNA was extracted from all tissue samples, using a Qiagen DNeasy Blood and Tissue Kit. The extracted DNA was amplified through PCR for 20 previously published microsatellite primers for *Etheostoma lemniscatum*. R was used to run a standard suit of population genetic analyses for genotypic data.
